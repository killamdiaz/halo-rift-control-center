          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="flex items-center justify-between p-3 bg-halo-darker bg-opacity-20 rounded-lg">
                ...
                <span className={`font-medium ${device.battery > 20 ? 'text-green-400' : 'text-red-400'}`}>
                  {device.battery}%
                </span>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-halo-darker bg-opacity-20 rounded-lg">
                ...
                <span className="text-white font-medium">{device.signal}%</span>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-halo-darker bg-opacity-20 rounded-lg">
                ...
                <span className="text-white font-medium font-mono text-sm">
                  {device.ipAddress || '192.168.1.142'}
                </span>
              </div>
